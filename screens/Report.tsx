        ...
        {emergencyTypes.map((emergency) => {
          ...
          return (
            <TouchableOpacity
              ...
              className={`w-[48%] p-6 rounded-2xl border-2 mb-4 ${
          ...
          <View className="flex-row items-center justify-between mb-2">
            ...
            <TouchableOpacity
              ...
              className={`w-12 h-6 rounded-full justify-center ${
                notifications.nearbyUsers ? 'bg-orange-500' : 'bg-gray-600'
              }`}
            >
              <View className={`w-4 h-4 bg-white rounded-full ${
                notifications.nearbyUsers ? 'self-end mr-1' : 'self-start ml-1'
              }`} />
            </TouchableOpacity>
          </View>
        ...
        <View className="p-4 bg-gray-800 rounded-xl">
          <View className="flex-row items-center justify-between mb-2">
            ...
            <TouchableOpacity
              ...
              className={`w-12 h-6 rounded-full justify-center ${
                notifications.trustedContacts ? 'bg-orange-500' : 'bg-gray-600'
              }`}
            >
              <View className={`w-4 h-4 bg-white rounded-full ${
                notifications.trustedContacts ? 'self-end mr-1' : 'self-start ml-1'
              }`} />
            </TouchableOpacity>
          </View>
        ...
        <View className="p-4 bg-gray-800 rounded-xl">
          <View className="flex-row items-center justify-between mb-2">
            ...
            <TouchableOpacity
              ...
              className={`w-12 h-6 rounded-full justify-center ${
                notifications.emergencyServices ? 'bg-orange-500' : 'bg-gray-600'
              }`}
            >
              <View className={`w-4 h-4 bg-white rounded-full ${
                notifications.emergencyServices ? 'self-end mr-1' : 'self-start ml-1'
              }`} />
            </TouchableOpacity>
          </View>
  ...
  const renderStep4 = () => (
    <View className="space-y-6">
      ...
      <View className="space-y-3">
        <TouchableOpacity 
          onPress={() => Alert.alert('Help Request Sent!', 'Your emergency request has been sent to selected contacts.')}
